                ...
                <div className="w-full md:max-w-4xl flex flex-col justify-end md:justify-center pl-0 md:pl-20">
                    ...
                    >
                        ...
                        <motion.h2
                            ...
                            className="text-xl md:text-3xl font-light text-white/90 mb-10 md:mb-12 tracking-wide leading-relaxed"
                        >
                        ...
                        <motion.p
                            ...
                            className="text-lg md:text-xl text-gray-400 mb-16 md:mb-16 max-w-lg md:max-w-xl mx-auto leading-loose font-light"
                        >
                            Stop chasing miracles.
                            Turn to a science backed solution designed for men and women in their 30s to 50s.
                        </motion.p>
